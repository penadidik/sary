 ...
 * 
 * @METHOD get
 * @URL /restapi/v1/tso/rooms/:room_id/control-temperature
 * @PARAM 
 */

router.post('/rooms/:room_id/control-temperature', function (req, res, next) {
...
router.get('/rooms/:room_id/temperature-status', function (req, res, next) {
	//temporary code
	res.json({
		code: 200,
		data:{
