 ...
 * 
 * @METHOD get
 * @URL /restapi/v1/tso/rooms/:room_id/control-lamp
 * @PARAM 
 */

router.post('/rooms/:room_id/control-lamp', function (req, res, next) {
...
router.get('/rooms/:room_id/lamp-status', function (req, res, next) {
	//temporary code
	res.json({
		code: 200,
		data:{
